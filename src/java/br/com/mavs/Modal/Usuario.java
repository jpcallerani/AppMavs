...
public class Usuario extends NamedFacebookType {
    ...
    /**
     * Represents the <a
     * href="https://developers.facebook.com/docs/payments/user_currency">Currency
     * Graph API type</a>.
     *
     * @author <a href="http://restfb.com">Mark Allen</a>
     * @since 1.6.12
    ...
    public static class Currency implements Serializable {
        ...
        /**
         * The ISO-4217-3 code for the user's preferred currency (defaulting to
         * USD if the user hasn't set one).
         *
         * @return The ISO-4217-3 code for the user's preferred currency
         * (defaulting to USD if the user hasn't set one).
         */
         ...
         * {@code user_currency}.
         *
         * @return The number of Facebook Credits that equate in value to one
         * unit of {@code user_currency}.
         */
        ...
        /**
         * The number of units of {@code user_currency} that equate in value to
         * one Credit.
         * <p>
         * To calculate the local currency amount based on the credits price,
         * compute {@code credits_price * currency_exchange_inverse}.
         *
         * @return The number of units of {@code user_currency} that equate in
         * value to one Credit.
         */
         ...
         * {@code user_currency} units.
         * <p>
         * For example, a price of $1.20 will be represented by the Facebook API
         * as "120", which you should divide by the USD {@code currency_offset}
         * of 100 to arrive back at 1.20.
         *
         * @return The number by which a price should be divided for display in
         * {@code user_currency} units.
         */
     ...
     * <p>
     * Will always succeed, even if the user has specified month/year format
     * only. If you'd like to use a typed version of this accessor, call
     ...
     * href="https://developers.facebook.com/docs/payments/user_currency">Displaying
     * prices in user's currency</a> page.
     *
    ...
    public StimeSegmento getsSegmento() {
        return sSegmento;
    }

    public void setsSegmento(StimeSegmento sSegmento) {
